...
class AnimeReviewsdataItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * User reaction count on the review.
     */
    public function setReactions(AnimeReviewReactions $animeReviewReactions): self
    {
        $this->initialized['reactions'] = true;
        $this->reactions = $animeReviewReactions;
