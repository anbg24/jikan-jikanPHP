...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class AnimeReviewsdataItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('reactions', $data)) {
                $animeReviewsdataItem->setReactions($this->denormalizer->denormalize($data['reactions'], AnimeReviewReactions::class, 'json', $context));
            ...
            if (\array_key_exists('score', $data)) {
                $animeReviewsdataItem->setScore($data['score']);
                unset($data['score']);
            }
            ...
            if (\array_key_exists('tags', $data)) {
                ...
                $animeReviewsdataItem->setTags($values);
                unset($data['tags']);
            }

            if (\array_key_exists('is_spoiler', $data)) {
                $animeReviewsdataItem->setIsSpoiler($data['is_spoiler']);
                unset($data['is_spoiler']);
            }

            if (\array_key_exists('is_preliminary', $data)) {
                $animeReviewsdataItem->setIsPreliminary($data['is_preliminary']);
            ...
            foreach ($data as $key => $value_1) {
                if (preg_match('#.*#', (string) $key)) {
                    $animeReviewsdataItem[$key] = $value_1;
                }
            }
    ...
    class AnimeReviewsdataItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
         ...
         */
        public function denormalize($data, $type, $format = null, array $context = []): Reference|AnimeReviewsdataItem
        {
            if (isset($data['$ref'])) {
                return new Reference($data['$ref'], $context['document-origin']);
            }
