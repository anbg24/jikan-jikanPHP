...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class AnimeVideosDataPromoItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('trailer', $data)) {
                ...
                $animeVideosDataPromoItem->setTrailer($arrayObject);
                unset($data['trailer']);
            }

            foreach ($data as $key_1 => $value_1) {
                if (preg_match('#.*#', (string) $key_1)) {
                    $animeVideosDataPromoItem[$key_1] = $value_1;
                }
            }
    ...
    class AnimeVideosDataPromoItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
         ...
         */
        public function denormalize($data, $type, $format = null, array $context = []): Reference|AnimeVideosDataPromoItem
        {
            if (isset($data['$ref'])) {
                return new Reference($data['$ref'], $context['document-origin']);
            }
