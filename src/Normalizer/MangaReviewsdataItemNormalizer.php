...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class MangaReviewsdataItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('reactions', $data)) {
                $mangaReviewsdataItem->setReactions($this->denormalizer->denormalize($data['reactions'], MangaReviewReactions::class, 'json', $context));
            ...
            if (\array_key_exists('score', $data)) {
                $mangaReviewsdataItem->setScore($data['score']);
                unset($data['score']);
            }
            ...
            if (\array_key_exists('tags', $data)) {
                ...
                $mangaReviewsdataItem->setTags($values);
                unset($data['tags']);
            }

            if (\array_key_exists('is_spoiler', $data)) {
                $mangaReviewsdataItem->setIsSpoiler($data['is_spoiler']);
                unset($data['is_spoiler']);
            }

            if (\array_key_exists('is_preliminary', $data)) {
                $mangaReviewsdataItem->setIsPreliminary($data['is_preliminary']);
                unset($data['is_preliminary']);
            }

            foreach ($data as $key => $value_1) {
                if (preg_match('#.*#', (string) $key)) {
                    $mangaReviewsdataItem[$key] = $value_1;
                }
            }
        ...
        {
            return [MangaReviewsdataItem::class => false];
        }
    }
} else {
    class MangaReviewsdataItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
         ...
         */
        public function denormalize($data, $type, $format = null, array $context = []): Reference|MangaReviewsdataItem
        {
            if (isset($data['$ref'])) {
                return new Reference($data['$ref'], $context['document-origin']);
            }
